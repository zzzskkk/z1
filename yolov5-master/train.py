...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default="yolov5s_any.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "data/any.yaml", help="dataset.yaml path")
